...
public class ActionInitDatabase extends ActionBase {
	...
	public ActionInitDatabase( ActionBase action , String stream , MetaEnvServer server ) {
		super( action , stream );
		this.server = server;
	}
	...
	@Override protected boolean executeSimple() throws Exception {
		...
		log( "initialize administrative database " + server.admSchema.DBNAME + " on database server " + server.NAME + " ..." );
	...
	private void executeInitScript( DatabaseClient client , LocalFolder scripts , LocalFolder logs , String file ) throws Exception {
		...
		if( !client.applyScript( this , server.admSchema , scripts , file , logs , logfile ) )
