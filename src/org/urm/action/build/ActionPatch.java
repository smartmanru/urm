...
public class ActionPatch extends ActionBase {
	...
	@Override protected SCOPESTATE executeSimple() throws Exception {
		...
		info( "ActionPatch: BUILDER=" + builder.builder.NAME + ", BUILDMODE=" + context.getBuildModeName() + ", CATEGORY=" + Common.getEnumLower( builder.project.CATEGORY ) + ", PROJECT=" + builder.project.PROJECT + 
