...
public class DeployCommand {
	...
	public void baseInstall( ActionBase action , ActionScope scope ) throws Exception {
		...
		ma.runAll( null , scope , action.context.env , SecurityAction.ACTION_DEPLOY , false );
	}
	...
	public void baseList( ActionBase action , ActionScope scope ) throws Exception {
		...
		ma.runEnvUniqueAccounts( null , scope , action.context.env , SecurityAction.ACTION_DEPLOY , false );
	}
	...
	public void deployRedist( ActionBase action , ActionScope scope , Dist dist ) throws Exception {
		...
		ca.runAll( null , scope , action.context.env , SecurityAction.ACTION_DEPLOY , false );
	}
	...
	public void dropRedist( ActionBase action , ActionScope scope , String releaseDir ) throws Exception {
		...
		if( action.isForced() )
			ca.runEnvUniqueHosts( null , scope , action.context.env , SecurityAction.ACTION_DEPLOY , false );
		else
			ca.runAll( null , scope , action.context.env , SecurityAction.ACTION_DEPLOY , false );
	}
	...
	public void changeKeys( ActionBase action , ActionScope scope , String CMD ) throws Exception {
		...
		ca.runEnvUniqueAccounts( null , scope , action.context.env , SecurityAction.ACTION_DEPLOY , false );
	}
	...
	public void login( ActionBase action , MetaEnvSegment sg , String SERVER , String NODE ) throws Exception {
		...
		ca.runSimpleEnv( null , sg.env , SecurityAction.ACTION_DEPLOY , false );
	}
	...
	public void redist( ActionBase action , ActionScope scope , Dist dist ) throws Exception {
		...
		if( action.context.CTX_CONFDEPLOY && !dist.release.isEmptyConfiguration() ) {
			...
			if( !check.runAll( null , scope , action.context.env , SecurityAction.ACTION_DEPLOY , false ) )
			...
			if( !ca.runAll( null , scope , action.context.env , SecurityAction.ACTION_DEPLOY , false ) )
		...
		if( !pa.runAll( null , scope , action.context.env , SecurityAction.ACTION_DEPLOY , false ) )
	...
	public void restartEnv( ActionBase action , ActionScope scope ) throws Exception {
		...
		if( !stop.runAll( null , scope , action.context.env , SecurityAction.ACTION_DEPLOY , false ) )
		...
		if( !start.runAll( null , scope , action.context.env , SecurityAction.ACTION_DEPLOY , false ) )
	...
	public void sendMsg( ActionBase action , String msg ) throws Exception {
		ActionSendChatMsg.sendMsg( null , action , msg , action.context.env , action.context.sg );
	}
