...
public class DeployCommandMeta extends CommandMeta {
	...
	public DeployCommandMeta( OptionsMeta options ) {
		...
		String cmdOpts = "OPT_ALL, OPT_DEPLOYGROUP, OPT_STARTGROUP, OPT_SG, OPT_EXTRAARGS, OPT_UNIT, OPT_BUILDINFO, OPT_TAG, OPT_HOSTUSER, OPT_KEY, OPT_NEWKEY, OPT_BACKUP, OPT_DEPLOYCONF, OPT_PARTIALCONF, OPT_DEPLOYBINARY, OPT_DEPLOYHOT, OPT_DEPLOYCOLD, OPT_KEEPALIVE, OPT_SKIPERRORS, OPT_ZERODOWNTIME, OPT_NONODES, OPT_NOCHATMSG, OPT_ROOTUSER, OPT_IGNOREVERSION";
		...
		cmdOpts = "OPT_DEPLOYGROUP, OPT_STARTGROUP, OPT_DBPASSWORD, OPT_SG, OPT_EXTRAARGS, OPT_UNIT, OPT_NONODES";
		...
		cmdOpts = "OPT_DEPLOYGROUP, OPT_STARTGROUP, OPT_SG, OPT_EXTRAARGS, OPT_UNIT, OPT_BACKUP, OPT_DEPLOYCONF, OPT_DEPLOYBINARY, OPT_DEPLOYHOT, OPT_DEPLOYCOLD, OPT_KEEPALIVE, OPT_ZERODOWNTIME, OPT_NOCHATMSG";
		...
		cmdOpts = "OPT_DEPLOYGROUP, OPT_STARTGROUP, OPT_SG, OPT_UNIT, OPT_RELEASE, OPT_DEPLOYCONF, OPT_DEPLOYBINARY, OPT_DEPLOYHOT, OPT_DEPLOYCOLD";
		...
		cmdOpts = "OPT_DEPLOYGROUP, OPT_STARTGROUP, OPT_SG, OPT_UNIT, OPT_BACKUP, OPT_DEPLOYCONF, OPT_DEPLOYBINARY, OPT_DEPLOYHOT, OPT_DEPLOYCOLD, OPT_KEEPALIVE, OPT_IGNOREVERSION";
		...
		cmdOpts = "OPT_DEPLOYGROUP, OPT_STARTGROUP, OPT_SG, OPT_EXTRAARGS, OPT_UNIT, OPT_DEPLOYCONF, OPT_DEPLOYBINARY, OPT_DEPLOYHOT, OPT_DEPLOYCOLD, OPT_KEEPALIVE";
		...
		cmdOpts = "OPT_RELEASE, OPT_STARTGROUP, OPT_DEPLOYGROUP, OPT_DBPASSWORD, OPT_SG, OPT_UNIT, OPT_BACKUP, OPT_DEPLOYCONF, OPT_DEPLOYBINARY, OPT_CHECK";
