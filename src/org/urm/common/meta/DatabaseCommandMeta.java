...
public class DatabaseCommandMeta extends CommandMeta {
	...
	public DatabaseCommandMeta( OptionsMeta options ) {
		...
		cmdOpts = "OPT_SG, OPT_DBPASSWORD";
		super.defineAction( CommandMethodMeta.newCritical( this , METHOD_IMPORT , ACTION_ACCESS.ENV , false , SecurityAction.ACTION_DEPLOY , false , "import specified in etc/datapump/file dump to database" , cmdOpts , "<task> {all|meta|data} [schema]" ) );
		cmdOpts = "OPT_SG, OPT_DBPASSWORD";
		super.defineAction( CommandMethodMeta.newNormal( this , METHOD_EXPORT , ACTION_ACCESS.ENV , true , SecurityAction.ACTION_DEPLOY , false , "export specified in etc/datapump/file dump from database" , cmdOpts , "<task> {all|meta|data [schema]}" ) );
	}
