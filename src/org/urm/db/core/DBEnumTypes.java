...
public abstract class DBEnumTypes {
	...
	public enum DBEnumBuildModeType implements DBEnumInterface {
		...
		public static DBEnumBuildModeType getValue( Integer value , boolean required ) throws Exception { return( DBEnumTypes.getValue( DBEnumBuildModeType.class , value , required , UNKNOWN ) ); };
		public static DBEnumBuildModeType getValue( String value , boolean required ) throws Exception { return( DBEnumTypes.getValue( DBEnumBuildModeType.class , value , required , UNKNOWN ) ); };
	};
	...
	public enum DBEnumObjectVersionType implements DBEnumInterface {
		...
		public static DBEnumObjectVersionType getValue( Integer value , boolean required ) throws Exception { return( DBEnumTypes.getValue( DBEnumObjectVersionType.class , value , required , null ) ); };
		public static DBEnumObjectVersionType getValue( String value , boolean required ) throws Exception { return( DBEnumTypes.getValue( DBEnumObjectVersionType.class , value , required , null ) ); };
	};
