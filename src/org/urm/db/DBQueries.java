...
public abstract class DBQueries {
	...
	public static String MODIFY_PARAM_ADDPARAM17 = "insert into urm_object_param ( param_object_id , paramentity_type , param_id , entitycolumn , name , dbname , xmlname , xdesc , paramvalue_type , paramvalue_subtype , object_type , enumname , required , secured , expr_def , customenum_def , version ) values ( @values@ )";
	public static String MODIFY_PARAM_UPDATEPARAM17 = "update urm_object_param set entitycolumn = @4@ , name = @5@ , dbname = @6@ , xmlname = @7@ , xdesc = @8@ , paramvalue_type = @9@ , paramvalue_subtype = @10@ , object_type = @11@ , enumname = @12@ , required = @13@ , secured = @14@ , expr_def = @15@ , customenum_def = @16@ , version = @17@ where param_object_id = @1@ and paramentity_type = @2@ and param_id = @3@";
	...
	public static String MODIFY_PARAM_DROPOBJECTPARAMVALUE3  = "delete from urm_object_param_value where object_id = @1@ and paramrole_type = @2@ and param_object_id = @3@";
