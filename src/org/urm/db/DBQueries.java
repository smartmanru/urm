...
public abstract class DBQueries {
	...
	public static String QUERY_NAMES_DROPPARENT1 = "delete from urm_object_name where parent = @1@";
	public static String QUERY_NAMES_ADDITEM4 = "insert into urm_object_name ( parent , name , id , object_type ) values ( @1@ , '@2@' , @3@ , @4@ )";
