...
public abstract class DBData {
	...
	public static void setNextVersion( DBConnection c , int id , int version ) throws Exception {
		if( !c.update( DBQueries.UPDATE_VERSIONS_MERGEVERSION2 , new String[] { "" + id , "" + version } ) )
	...
	public static void dropEngineAuthData( DBConnection c ) throws Exception {
		boolean res = true;
		res = ( res )? c.update( DBQueries.UPDATE_AUTH_DROP_ACCESSPRODUCT0 ) : false;
		res = ( res )? c.update( DBQueries.UPDATE_AUTH_DROP_ACCESSRESOURCE0 ) : false;
		res = ( res )? c.update( DBQueries.UPDATE_AUTH_DROP_ACCESSNETWORK0 ) : false;
		res = ( res )? c.update( DBQueries.UPDATE_AUTH_DROP_USER0 ) : false;
		res = ( res )? c.update( DBQueries.UPDATE_AUTH_DROP_GROUP0 ) : false;
		if( !res )
			Common.exitUnexpected();
	}
	...
	public static void dropEngineInfraData( DBConnection c ) throws Exception {
		boolean res = true;
		res = ( res )? c.update( DBQueries.UPDATE_INFRA_DROP_ACCOUNT0 ) : false;
		res = ( res )? c.update( DBQueries.UPDATE_INFRA_DROP_HOST0 ) : false;
		res = ( res )? c.update( DBQueries.UPDATE_INFRA_DROP_NETWORK0 ) : false;
		res = ( res )? c.update( DBQueries.UPDATE_INFRA_DROP_DATACENTER0 ) : false;
		if( !res )
			Common.exitUnexpected();
	}
	...
	public static void dropEngineBaseData( DBConnection c ) throws Exception {
		boolean res = true;
		res = ( res )? c.update( DBQueries.UPDATE_BASE_DROP_ITEMDEPS0 ) : false;
		res = ( res )? c.update( DBQueries.UPDATE_BASE_DROP_ITEM0 ) : false;
		res = ( res )? c.update( DBQueries.UPDATE_BASE_DROP_GROUP0 ) : false;
		res = ( res )? c.update( DBQueries.UPDATE_BASE_DROP_CATEGORY0 ) : false;
		if( !res )
			Common.exitUnexpected();
	}
	...
	public static void dropEngineAppData( DBConnection c ) throws Exception {
		boolean res = true;
		res = ( res )? c.update( DBQueries.UPDATE_APP_DROP_SYSTEMPARAM0 ) : false;
		res = ( res )? c.update( DBQueries.UPDATE_APP_DROP_PRODUCT0 ) : false;
		res = ( res )? c.update( DBQueries.UPDATE_APP_DROP_SYSTEM0 ) : false;
		if( !res )
			Common.exitUnexpected();
	}
