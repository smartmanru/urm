...
public class DBEngineAuth {
	...
	public static PropertyEntity makeEntityAuthGroup( DBConnection c , boolean upgrade ) throws Exception {
		...
		return( DBSettings.savedbObjectEntity( c , entity , new EntityVar[] { 
				...
				EntityVar.metaBooleanDatabaseOnly( AuthGroup.PROPERTY_SPECIAL_SECURED , "" , true , false ) ,
	...
	private static void modifyGroup( DBConnection c , AuthGroup group , boolean insert ) throws Exception {
		...
		DBEngineEntities.modifyAppObject( c , entities.entityAppAuthGroup , group.ID , group.UV , new String[] {
				...
				EngineDB.getBoolean( group.checkSpecialPermission( SpecialRights.SPECIAL_SECURED ) ) ,
